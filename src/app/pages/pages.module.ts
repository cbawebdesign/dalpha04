...
import {  GetverifiedComponent } from 'src/app/pages/getverified/getverified.component';

@NgModule({
  declarations: [ StrategyComponent, VerifyComponent, GetverifiedComponent,VerifieduserComponent, VerifyEmailComponent, SigninComponent, PasswordlessAuthComponent, DashboardComponent, LoginComponent, ResponsibilityComponent, PortfolioComponent, DisclaimersComponent, OurteamComponent, PortfolioCardComponent,  DalphateamComponent, DalphaportfolioComponent,  /*ContactusComponent*/],
  imports: [
    CommonModule,
    FormsModule,
    HomeModule,
